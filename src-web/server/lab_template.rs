...
fn render_explorer(html: &mut String, session: &Session) {
    ...
    html.push_str(r#"<section class="explorer-area" id="explorer-area-data" data-area-panel="data" data-area-title="Data" data-area-subtitle="Project datasets" hidden><div class="area-metrics"><span><strong data-workspace-field="counts.datasets">0</strong>datasets</span></div><p class="area-summary">No dataset object service is registered in this build. Existing computations remain available in Work.</p><div class="capability-list">"#);
    ...
    html.push_str(r#"</div></section></div><footer class="explorer-footer"><span><i></i><span><strong>CentL26 Core</strong><small>Ready · local</small></span></span></footer></aside>"#);
}
