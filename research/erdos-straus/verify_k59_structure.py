#!/usr/bin/env python3
"""Independent finite regression for the exact k=59 state classification."""
...
import classify_k59_states as k59
...
def analyze(limit: int) -> dict[str, object]:
    ...
    for p in hard:
        ...
        if state not in closed:
            ...
            continue
        predicted_hit = not k59.is_miss(state)
...
def main() -> int:
    ...
    args = ap.parse_args()
    if args.limit < MOD:
        raise SystemExit("--limit must be >= 59")
