...
def main() -> int:
    ...
    for t in range(124):
        ...
        if t % 2:
            assert v["D"] % 2 == 0
            # Any k31 miss here contains prime-factor residue2, which is QR31
            # but outside H31. Therefore BARE is impossible and FULL_QR is forced.
        ...
        parity_rows.append({"t_mod4": t % 4, **s})

    # The BARE stabilizer contains only odd residue classes, so a number whose
    # complete prime support lies in H31 cannot contain the rational prime2.
