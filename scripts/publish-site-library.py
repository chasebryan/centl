...
JavaScript. Typeahead on the library page uses a native <datalist>.
"""
...
MANUALS: list[tuple[str, str, str]] = [
    ...
    ("docs/releases/26.10.2.md", "release-26.10.2", "CentL26.10.2 Release"),
    ...
    ("docs/CHEMISTRY.md", "chemistry", "Stoichiometry & Reaction Balancing"),
    ("docs/CENTL26-ARCHITECTURE.md", "centl26-architecture", "CentL26 Architecture Guide"),
...
def wrap_page(
    *,
    ...
    prefix = "../" * depth
    css_href = f"{prefix}style.css{css_query}"
