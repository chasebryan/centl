  ...
  $ chmod 755 release-fixture/centl/bin/centl release-fixture/centl/libexec/centl release-fixture/centl/bin/centl-physics release-fixture/centl/libexec/centl-physics
  ...
  $ HOME="$PWD/home" ../install --archive "$PWD/centl-linux-x86_64.tar.gz" --prefix "$PWD/occupied-physics" 2>&1
