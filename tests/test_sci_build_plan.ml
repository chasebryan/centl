...
let test_capability_reuse_is_in_plan () =
  ...
  Alcotest.(check bool)
    "existing integration capability appears" true
    (List.exists
       (fun value ->
         Option.is_some
    ...
    [
      ( "classification",
        [
          ...
          Alcotest.test_case "core patch" `Quick test_core_patch_classification;
          Alcotest.test_case "upstream" `Quick test_upstream_classification;
        ] );
      ( "reuse and trust",
        [
