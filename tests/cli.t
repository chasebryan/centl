  ...
  {"version":1,"ok":true,"value":{"kind":"rational","exact":true,"numerator":"1","denominator":"8","text":"1/8"},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.9.1"},"classification":"exact","method":"rational_evaluation","backend":"centl-core"}}

  $ ../src/main.exe --json 'integrate(x^2, x = 0, 1)'
  {"version":1,"ok":true,"value":{"kind":"rational","exact":true,"numerator":"1","denominator":"3","text":"1/3"},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.9.1"},"classification":"exact","method":"rational_evaluation","backend":"centl-core"}}

  $ ../src/main.exe --json 'sum(k, k = 1, 10)'
  {"version":1,"ok":true,"value":{"kind":"integer","exact":true,"value":"55","text":"55"},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.9.1"},"classification":"exact","method":"rational_evaluation","backend":"centl-core"}}

  $ ../src/main.exe --json 'diff(sin(x), x)'
  {"version":1,"ok":true,"value":{"kind":"symbolic","exact":true,"expression":"cos(x)","text":"cos(x)"},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.9.1"},"classification":"exact_symbolic","method":"symbolic_evaluation","backend":"centl-core"}}
  ...
  {"version":1,"id":"c","ok":true,"reset":true,"provenance":{"schema":1,"producer":{"name":"centl","version":"0.9.1"},"classification":"control","method":"reset","backend":"centl-protocol"},"session":{"definitions":0,"requests":3}}
  ...
  {"version":1,"id":"limit","ok":false,"error":{"code":"precision_limit","message":"approximation digits must be between 1 and 10"},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.9.1"},"classification":"failure","method":"evaluation","backend":"centl-runtime"},"session":{"definitions":0,"requests":1}}

  $ printf '%s\n' '{"version":1,"id":"n","expression":"n = 6"}' '{"version":1,"id":"factorial","expression":"product(k, k = 1, n)"}' | ../src/main.exe --serve | tail -n 1
  {"version":1,"id":"factorial","ok":true,"value":{"kind":"integer","exact":true,"value":"720","text":"720"},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.9.1"},"classification":"exact","method":"rational_evaluation","backend":"centl-core"},"session":{"definitions":1,"requests":2}}
  ...
  {"version":1,"ok":false,"error":{"code":"invalid_request","message":"unsupported protocol version"},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.9.1"},"classification":"failure","method":"evaluation","backend":"centl-runtime"}}
  [2]
