  ...
  {"version":1,"ok":true,"value":{"kind":"rational","exact":true,"numerator":"1","denominator":"8","text":"1/8"},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.9.0"},"classification":"exact","method":"rational_evaluation","backend":"centl-core"}}

  $ ../src/main.exe --json 'integrate(x^2, x = 0, 1)'
  {"version":1,"ok":true,"value":{"kind":"rational","exact":true,"numerator":"1","denominator":"3","text":"1/3"},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.9.0"},"classification":"exact","method":"rational_evaluation","backend":"centl-core"}}

  $ ../src/main.exe --json 'sum(k, k = 1, 10)'
  {"version":1,"ok":true,"value":{"kind":"integer","exact":true,"value":"55","text":"55"},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.9.0"},"classification":"exact","method":"rational_evaluation","backend":"centl-core"}}

  $ ../src/main.exe --json 'diff(sin(x), x)'
  {"version":1,"ok":true,"value":{"kind":"symbolic","exact":true,"expression":"cos(x)","text":"cos(x)"},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.9.0"},"classification":"exact_symbolic","method":"symbolic_evaluation","backend":"centl-core"}}
  ...
  {"version":1,"ok":true,"value":{"kind":"integer","exact":true,"value":"14","text":"14"},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.9.0"},"classification":"exact","method":"rational_evaluation","backend":"centl-core"}}

  $ printf '%s\n' '{"version":1,"id":"a","expression":"r = 3"}' '{"version":1,"id":"b","expression":"circle_area(r)"}' '{"version":1,"id":"c","op":"reset"}' | ../src/main.exe --serve
  {"version":1,"id":"a","ok":true,"value":{"kind":"definition","exact":true,"definition_kind":"value","name":"r","value":{"kind":"integer","exact":true,"value":"3","text":"3"},"text":"r = 3"},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.9.0"},"classification":"exact_definition","method":"session_binding","backend":"centl-session"},"session":{"definitions":1,"requests":1}}
  {"version":1,"id":"b","ok":true,"value":{"kind":"symbolic","exact":true,"expression":"9 * pi","text":"9 * pi"},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.9.0"},"classification":"exact_symbolic","method":"symbolic_evaluation","backend":"centl-core"},"session":{"definitions":1,"requests":2}}
  {"version":1,"id":"c","ok":true,"reset":true,"provenance":{"schema":1,"producer":{"name":"centl","version":"0.9.0"},"classification":"control","method":"reset","backend":"centl-protocol"},"session":{"definitions":0,"requests":3}}
  ...
  {"version":1,"id":"limit","ok":false,"error":{"code":"precision_limit","message":"approximation digits must be between 1 and 10"},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.9.0"},"classification":"failure","method":"evaluation","backend":"centl-runtime"},"session":{"definitions":0,"requests":1}}

  $ printf '%s\n' '{"version":1,"id":"n","expression":"n = 6"}' '{"version":1,"id":"factorial","expression":"product(k, k = 1, n)"}' | ../src/main.exe --serve | tail -n 1
  {"version":1,"id":"factorial","ok":true,"value":{"kind":"integer","exact":true,"value":"720","text":"720"},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.9.0"},"classification":"exact","method":"rational_evaluation","backend":"centl-core"},"session":{"definitions":1,"requests":2}}

  $ printf '{"version":1,"id":"limit-sum","expression":"sum(k, k = 1, 4)","limits":{"max_integer_iterations":3}}\n' | ../src/main.exe --serve
  {"version":1,"id":"limit-sum","ok":false,"error":{"code":"resource_limit","message":"the finite iteration exceeds the integer-iteration limit"},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.9.0"},"classification":"failure","method":"evaluation","backend":"centl-runtime"},"session":{"definitions":0,"requests":1}}
  ...
  {"jsonrpc":"2.0","id":1,"result":{"protocolVersion":"2025-11-25","capabilities":{"tools":{"listChanged":false}},"serverInfo":{"name":"centl","title":"CENTL exact mathematics","version":"0.9.0"},"instructions":"Use centl_calculate for exact, symbolic, or rigorously enclosed mathematics. Definitions persist until centl_reset or process exit."}}
  {"jsonrpc":"2.0","id":2,"result":{"content":[{"type":"text","text":"3/10"}],"structuredContent":{"version":1,"ok":true,"value":{"kind":"rational","exact":true,"numerator":"3","denominator":"10","text":"3/10"},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.9.0"},"classification":"exact","method":"rational_evaluation","backend":"centl-core"},"session":{"definitions":0,"requests":3}},"isError":false}}
  ...
  {"version":1,"ok":false,"error":{"code":"invalid_request","message":"unsupported protocol version"},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.9.0"},"classification":"failure","method":"evaluation","backend":"centl-runtime"}}
  [2]
