  ...
  {"version":1,"ok":true,"value":{"kind":"rational","exact":true,"numerator":"1","denominator":"8","text":"1/8"},"resolution":{"status":"computed"},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.13.0"},"classification":"exact","method":"rational_evaluation","backend":"centl-core"}}

  $ ../src/main.exe --json 'integrate(x^2, x = 0, 1)'
  {"version":1,"ok":true,"value":{"kind":"rational","exact":true,"numerator":"1","denominator":"3","text":"1/3"},"resolution":{"status":"transformed","operation":"integrate","supported_domain":"rational-coefficient univariate polynomials with exact rational bounds"},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.13.0"},"classification":"exact","method":"rational_evaluation","backend":"centl-core"}}

  $ ../src/main.exe --json 'sum(k, k = 1, 10)'
  {"version":1,"ok":true,"value":{"kind":"integer","exact":true,"value":"55","text":"55"},"resolution":{"status":"computed"},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.13.0"},"classification":"exact","method":"rational_evaluation","backend":"centl-core"}}

  $ ../src/main.exe --json 'diff(sin(x), x)'
  {"version":1,"ok":true,"value":{"kind":"symbolic","exact":true,"expression":"cos(x)","text":"cos(x)"},"resolution":{"status":"transformed","operation":"diff","supported_domain":"the documented exact symbolic differentiation rules"},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.13.0"},"classification":"exact_symbolic","method":"symbolic_evaluation","backend":"centl-core"}}
  ...
  {"version":1,"ok":true,"value":{"kind":"integer","exact":true,"value":"14","text":"14"},"resolution":{"status":"computed"},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.13.0"},"classification":"exact","method":"rational_evaluation","backend":"centl-core"}}

  $ printf '{"version":1,"id":"one-shot","op":"evaluate","expression":"1 + 1"}\n' | ../src/main.exe --json
  {"version":1,"id":"one-shot","ok":true,"value":{"kind":"integer","exact":true,"value":"2","text":"2"},"resolution":{"status":"computed"},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.13.0"},"classification":"exact","method":"rational_evaluation","backend":"centl-core"}}

  $ { awk 'BEGIN { for (i = 0; i < 65537; i++) printf "x"; print "" }'; printf '{"version":1,"expression":"1 + 1"}\n'; } | ../src/main.exe --json
  {"version":1,"ok":false,"error":{"details":{"category":"limit","limit":"max_request_bytes"},"suggestion":"Reduce the request or retry with a larger permitted request limit.","code":"resource_limit","message":"the request exceeds the byte limit","retryable":true},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.13.0"},"classification":"failure","method":"evaluation","backend":"centl-runtime"}}
  {"version":1,"ok":true,"value":{"kind":"integer","exact":true,"value":"2","text":"2"},"resolution":{"status":"computed"},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.13.0"},"classification":"exact","method":"rational_evaluation","backend":"centl-core"}}
  [2]
  ...
  {"version":1,"id":"a","ok":true,"value":{"kind":"definition","exact":true,"definition_kind":"value","name":"r","value":{"kind":"integer","exact":true,"value":"3","text":"3"},"text":"r = 3"},"resolution":{"status":"computed"},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.13.0"},"classification":"exact_definition","method":"session_binding","backend":"centl-session"},"session":{"definitions":1,"requests":1}}
  {"version":1,"id":"b","ok":true,"value":{"kind":"symbolic","exact":true,"expression":"9 * pi","text":"9 * pi"},"resolution":{"status":"computed"},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.13.0"},"classification":"exact_symbolic","method":"symbolic_evaluation","backend":"centl-core"},"session":{"definitions":1,"requests":2}}
  {"version":1,"id":"c","ok":true,"reset":true,"provenance":{"schema":1,"producer":{"name":"centl","version":"0.13.0"},"classification":"control","method":"reset","backend":"centl-protocol"},"session":{"definitions":0,"requests":3}}
  ...
  {"version":1,"id":"name","ok":false,"error":{"position":0,"range":{"start":0,"end":0},"code":"reserved_name","message":"pi is built in and cannot be redefined","retryable":false},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.13.0"},"classification":"failure","method":"evaluation","backend":"centl-runtime"},"session":{"definitions":0,"requests":1}}
  {"version":1,"id":"parameter","ok":false,"error":{"position":5,"range":{"start":5,"end":5},"code":"invalid_definition","message":"function parameters must be unique","retryable":false},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.13.0"},"classification":"failure","method":"evaluation","backend":"centl-runtime"},"session":{"definitions":0,"requests":2}}
  {"version":1,"id":"empty","ok":false,"error":{"position":2,"range":{"start":2,"end":2},"code":"invalid_definition","message":"a function definition needs at least one parameter","retryable":false},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.13.0"},"classification":"failure","method":"evaluation","backend":"centl-runtime"},"session":{"definitions":0,"requests":3}}
  ...
  {"version":1,"id":"comp","ok":true,"value":{"kind":"integer","exact":true,"value":"9","text":"9"},"resolution":{"status":"computed"},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.13.0"},"classification":"exact","method":"rational_evaluation","backend":"centl-core"},"session":{"definitions":1,"requests":2}}
  {"version":1,"id":"bad","ok":false,"error":{"suggestion":"Use the explicit define operation for session definitions.","position":0,"range":{"start":0,"end":0},"code":"definition_not_allowed","message":"compute accepts expressions only and cannot define session state","retryable":false},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.13.0"},"classification":"failure","method":"evaluation","backend":"centl-runtime"},"session":{"definitions":1,"requests":3}}
  {"version":1,"id":"sess","ok":true,"definitions":[{"kind":"value","name":"r","expression":"3","dependencies":[]}],"provenance":{"schema":1,"producer":{"name":"centl","version":"0.13.0"},"classification":"control","method":"session_inspection","backend":"centl-protocol"},"session":{"definitions":1,"requests":4}}
  {"version":1,"id":"help","ok":true,"help":{"entries":[{"section":"Symbolic math","form":"factor(expression)","meaning":"factor a polynomial"},{"section":"Concrete math","form":"factorial(n)","meaning":"n factorial"}],"examples":[],"query":"factor"},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.13.0"},"classification":"control","method":"syntax_help","backend":"centl-protocol"},"session":{"definitions":1,"requests":5}}
  ...
  {"jsonrpc":"2.0","id":1,"result":{"protocolVersion":"2025-11-25","capabilities":{"tools":{"listChanged":false}},"serverInfo":{"name":"centl","title":"CENTL exact mathematics","version":"0.13.0"},"instructions":"Use read-only centl_compute for mathematics, centl_verify for structured claims, and centl_define for immutable session definitions. centl_calculate remains available for compatibility. Definitions persist until centl_reset or process exit."}}
  {"jsonrpc":"2.0","id":2,"result":{"content":[{"type":"text","text":"3/10"}],"structuredContent":{"version":1,"ok":true,"value":{"kind":"rational","exact":true,"numerator":"3","denominator":"10","text":"3/10"},"resolution":{"status":"computed"},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.13.0"},"classification":"exact","method":"rational_evaluation","backend":"centl-core"},"session":{"definitions":0,"requests":3}},"isError":false}}
  ...
  {"version":1,"id":"v1","ok":true,"verification":{"schema":1,"verdict":"verified","scope":"closed_exact_rational","method":"closed_rational_comparison","claim":{"left":"0.1 + 0.2","relation":"equal","right":"3/10","variables":[],"assumptions":[]},"evidence":{"left":{"kind":"rational","text":"3/10","numerator":"3","denominator":"10"},"right":{"kind":"rational","text":"3/10","numerator":"3","denominator":"10"},"comparison":"equal","left_resolution":{"status":"computed"},"right_resolution":{"status":"computed"}},"assurance":{"class":"exact_algorithm"},"producer":{"name":"centl","version":"0.13.0"}},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.13.0"},"classification":"verification","method":"claim_verification","backend":"centl-verify"},"session":{"definitions":0,"requests":1}}
  {"version":1,"id":"v2","ok":true,"verification":{"schema":1,"verdict":"refuted","scope":"closed_exact_rational","method":"closed_rational_comparison","claim":{"left":"1+1","relation":"equal","right":"3","variables":[],"assumptions":[]},"evidence":{"left":{"kind":"integer","text":"2","numerator":"2","denominator":"1"},"right":{"kind":"integer","text":"3","numerator":"3","denominator":"1"},"comparison":"less","left_resolution":{"status":"computed"},"right_resolution":{"status":"computed"}},"assurance":{"class":"exact_algorithm"},"producer":{"name":"centl","version":"0.13.0"}},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.13.0"},"classification":"verification","method":"claim_verification","backend":"centl-verify"},"session":{"definitions":0,"requests":2}}
  ...
  {"version":1,"ok":false,"error":{"code":"invalid_request","message":"unsupported protocol version","retryable":false},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.13.0"},"classification":"failure","method":"evaluation","backend":"centl-runtime"}}
  [2]
