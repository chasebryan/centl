  ...
  {"version":1,"ok":true,"value":{"kind":"rational","exact":true,"numerator":"1","denominator":"8","text":"1/8"},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.10.0"},"classification":"exact","method":"rational_evaluation","backend":"centl-core"}}

  $ ../src/main.exe --json 'integrate(x^2, x = 0, 1)'
  {"version":1,"ok":true,"value":{"kind":"rational","exact":true,"numerator":"1","denominator":"3","text":"1/3"},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.10.0"},"classification":"exact","method":"rational_evaluation","backend":"centl-core"}}

  $ ../src/main.exe --json 'sum(k, k = 1, 10)'
  {"version":1,"ok":true,"value":{"kind":"integer","exact":true,"value":"55","text":"55"},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.10.0"},"classification":"exact","method":"rational_evaluation","backend":"centl-core"}}

  $ ../src/main.exe --json 'diff(sin(x), x)'
  {"version":1,"ok":true,"value":{"kind":"symbolic","exact":true,"expression":"cos(x)","text":"cos(x)"},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.10.0"},"classification":"exact_symbolic","method":"symbolic_evaluation","backend":"centl-core"}}

  $ ../src/main.exe --json 'assuming(x / x, x != 0)'
  {"version":1,"ok":true,"value":{"kind":"symbolic","exact":true,"expression":"1 where x != 0","text":"1 where x != 0","conditions":[{"left":"x","relation":"not_equal","right":"0","text":"x != 0"}]},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.10.0"},"classification":"exact_symbolic","method":"symbolic_evaluation","backend":"centl-core"}}
  ...
  {"version":1,"ok":true,"value":{"kind":"integer","exact":true,"value":"2","text":"2"},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.10.0"},"classification":"exact","method":"rational_evaluation","backend":"centl-core"}}
  [2]
  ...
  {"version":1,"id":"b","ok":true,"value":{"kind":"symbolic","exact":true,"expression":"9 * pi","text":"9 * pi"},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.10.0"},"classification":"exact_symbolic","method":"symbolic_evaluation","backend":"centl-core"},"session":{"definitions":1,"requests":2}}
  ...
  {"version":1,"id":"factorial","ok":true,"value":{"kind":"integer","exact":true,"value":"720","text":"720"},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.10.0"},"classification":"exact","method":"rational_evaluation","backend":"centl-core"},"session":{"definitions":1,"requests":2}}
  ...
  {"jsonrpc":"2.0","id":1,"result":{"protocolVersion":"2025-11-25","capabilities":{"tools":{"listChanged":false}},"serverInfo":{"name":"centl","title":"CENTL exact mathematics","version":"0.10.0"},"instructions":"Use centl_calculate for exact, symbolic, or rigorously enclosed mathematics. Definitions persist until centl_reset or process exit."}}
  {"jsonrpc":"2.0","id":2,"result":{"content":[{"type":"text","text":"3/10"}],"structuredContent":{"version":1,"ok":true,"value":{"kind":"rational","exact":true,"numerator":"3","denominator":"10","text":"3/10"},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.10.0"},"classification":"exact","method":"rational_evaluation","backend":"centl-core"},"session":{"definitions":0,"requests":3}},"isError":false}}
