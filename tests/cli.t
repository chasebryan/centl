  ...
  {"jsonrpc":"2.0","id":2,"result":{"content":[{"type":"text","text":"x^2 + 1\nresolution: unsupported (operation=factor; reason=no_supported_factorization; supported_domain=difference-of-squares and rational-root univariate polynomials)"}],"structuredContent":{"version":1,"ok":true,"value":{"kind":"symbolic","exact":true,"expression":"x^2 + 1","text":"x^2 + 1"},"resolution":{"status":"unsupported","operation":"factor","reason":"no_supported_factorization","supported_domain":"difference-of-squares and rational-root univariate polynomials"},"provenance":{"schema":1,"producer":{"name":"centl","version":"0.11.0"},"classification":"exact_symbolic","method":"symbolic_evaluation","backend":"centl-core"},"session":{"definitions":0,"requests":3}},"isError":false}}
