...
let polynomial_factorization_request_schema =
  one_of
    [
      strict_object [ ("action", const_string "capabilities") ] [ "action" ];
      strict_object
...
let input_schema =
  one_of
    [
      ...
      strict_object
        [
          ("domain", const_string "polynomial_factorization");
          ("request", polynomial_factorization_request_schema);
        ]
        [ "domain"; "request" ];
      strict_object
        [
