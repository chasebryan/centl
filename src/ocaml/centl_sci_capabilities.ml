...
let builtins =
  [
    ...
    };
    {
      ...
      assurance = "core";
      summary =
        "exact deterministic lowering for factorials, Fibonacci numbers, gcd, \
         lcm, combinations, and permutations";
    };
    {
      ...
      assurance = "core";
      summary =
        "exact finite sequence, summation, and product computations through \
         CENTL's existing iteration surface";
    };
    {
      name = "geometry";
      aliases =
      ...
      assurance = "core";
      summary =
        "exact deterministic lowering for supported area, volume, distance, \
         slope, and hypotenuse formulas";
    };
    {
